...
const DynamicImageViewer = forwardRef<DynamicViewerRef, DynamicViewerProps>(
    ({ tilesData, onReset }, ref) => {
                        ...
                        <div className="mt-1 pt-1 border-t border-cyan-500/30">
                            <div className="text-[9px] sm:text-[10px] text-cyan-400/40">
                                {loading
                                    ...
                                    : isZoomLoading
                                        ? 'Loading tiles...'
                                        : `${tilesData.width.toLocaleString()}×${tilesData.height.toLocaleString()} px`}
                            </div>
                        </div>
                    </div>
                </div>
...
DynamicImageViewer.displayName = 'DynamicImageViewer';
